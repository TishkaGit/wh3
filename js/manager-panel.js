...
function printContract(contractId, forPdf = false) {
    try {
...
<body>
    ...
    <div class="signatures">
        <div class="signature-block"><p>Поставщик:</p><p>_________________ / _________________</p></div>
        <div class="signature-block"><p>Покупатель:</p><p>_________________ / _________________</p></div>
    </div>
